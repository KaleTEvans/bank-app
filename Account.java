...
public class Account {
    ...
    void getPreviousTransaction() {
        if (previousTransaction > 0) {
            ...
            System.out.println("Withrawn: " + previousTransaction);
        } else {
    ...
    void calculateInterest(int years) {
        ...
        System.out.println("The current rate is " + (100 * interestRate));
    ...
    void showMenu() {
        ...
        System.out.println("C. Make a wuthdrawal");
        ...
        do {
            ...
            switch(option) {
                ...
                // default case lets user know they entered an invalid account
                default:
